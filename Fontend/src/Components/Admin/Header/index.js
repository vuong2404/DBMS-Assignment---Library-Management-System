import { AiOutlineArrowDown, AiOutlineLogout, AiOutlineMenu, AiOutlineSetting, AiOutlineUser } from "react-icons/ai"
...
function Header() {
    ...
    return (
        ...
        >
            <div className="h-100 ps-4 d-flex align-items-center" style={{width: "var(--sidebar-width)"}}>
